...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboarddepartment">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/dashboarddepartment">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboarddepartment/profile" hidden>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('assets/img/formal.jpg') }}">
                            </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/logout" method="POST">
                        ...
                        <a type="submit" class="btn btn-primary" href="/">Logout</a>
                    </form>
                </div>
            </div>
        </div>
