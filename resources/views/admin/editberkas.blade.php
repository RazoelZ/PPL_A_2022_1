                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-h5">
                            ...
                            <img src="{{ asset('/storage/post-scansks/' . $item->scansks) }}" alt="{{ $item->scansks }}"
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-h5">
                            ...
                            <img src="{{ asset('/storage/post-scanpkl/' . $item->scanpkl) }}" alt="{{ $item->scanpkl }}"
                                width="250px" height="200px">
                            <br>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-h5">
                            ...
                            <img src="{{ asset('/storage/post-scankhs/' . $item->scankhs) }}" alt="{{ $item->scankhs }}"
                                width="250px" height="200px">
                            <br>
