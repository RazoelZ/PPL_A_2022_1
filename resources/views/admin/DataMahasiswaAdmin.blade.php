      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Isi Data Anda:</h6>
            <a class="collapse-item" href="#">IRS</a>
            <a class="collapse-item" href="#">KHS</a>
            <a class="collapse-item" href="#">PKL</a>
            <a class="collapse-item" href="#">Skripsi</a>
          </div>
        </div>
      </li>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <thead class="text-white" style="background-color:rgb(94, 80, 117)">
                    <tr>
                      <th>Nama></th>
                      <th>NIM</th>
                      <th>IRS</th>
                  ...
                  <tbody class="text-dark" style="background-color:#D9D9D9" class="text-center">
                    <tr>
                      <td>Joko Subagyo</td>
                      <td>24060120140144</td>
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="orange" class="bi bi-circle-fill" viewBox="0 0 16 16">
                      ...
                      <td>
                        <checked autocomplete="off">
                          <label class="btn btn-primary" for="btn-check-2">Edit</label>
                      </td>
                    </tr>
                    <tr>
                      <td>Anov Wijaya</td>
                      <td>24060120140143</td>
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="orange" class="bi bi-circle-fill" viewBox="0 0 16 16">
                          <circle cx="8" cy="8" r="8" />
                        </svg></td>
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="red" class="bi bi-circle-fill" viewBox="0 0 16 16">
                          <circle cx="8" cy="8" r="8" />
                        </svg></td>
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="orange" class="bi bi-circle-fill" viewBox="0 0 16 16">
                          <circle cx="8" cy="8" r="8" />
                    ...
                    <tr>
                      ...
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="yellow" class="bi bi-circle-fill" viewBox="0 0 16 16">
                          <circle cx="8" cy="8" r="8" />
                        </svg></td>
                      <td><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="orange" class="bi bi-circle-fill" viewBox="0 0 16 16">
                          <circle cx="8" cy="8" r="8" />
